...
public class StudentInfoJson : Blueprint{
    ...
    public override void format() {
        School                       = formatSTR(School);
        WeightedGrades               = formatSTR(WeightedGrades);
        AverageGrades                = formatSTR(AverageGrades);
        TimeLimitEnteringPrenotation = formatSTR(TimeLimitEnteringPrenotation);
        TimeLimitLeavingPrenotation  = formatSTR(TimeLimitLeavingPrenotation);
